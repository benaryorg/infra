          ...
          powerdns =
          {
            ...
            extraConfig =
              ...
              in
                ''
                  api=no
                  remote-connection-string=pipe:command=${lxddns}/bin/lxddns-http pipe -v info --domain ${config.benaryorg.lxd.cluster}. --hostmaster ${config.benaryorg.lxd.hostmaster} ${remotes} --soa-ttl 64 --aaaa-ttl 256,timeout=5000
                  launch=remote

{
  inputs =
  {
    nixpkgs.url = "tarball+https://git.shell.bsocat.net/nixpkgs/snapshot/nixpkgs-nixos-23.05.tar.gz";
    nixpkgs-unstable.url = "tarball+https://git.shell.bsocat.net/nixpkgs/snapshot/nixpkgs-unstable.tar.gz";
    ragenix.url = "tarball+https://git.shell.bsocat.net/ragenix/snapshot/ragenix-HEAD.tar.gz";
    ...
    colmena.url = "tarball+https://git.shell.bsocat.net/colmena/snapshot/colmena-HEAD.tar.gz";
    ...
    agenix.url = "tarball+https://git.shell.bsocat.net/agenix/snapshot/agenix-HEAD.tar.gz";
    agenix.inputs.nixpkgs.follows = "nixpkgs";
    agenix.inputs.home-manager.follows = "home-manager";
    agenix.inputs.darwin.follows = "darwin";
    flake-compat.url = "tarball+https://git.shell.bsocat.net/flake-compat/snapshot/flake-compat-HEAD.tar.gz";
    flake-compat.flake = false;
    flake-utils.url = "tarball+https://git.shell.bsocat.net/flake-utils/snapshot/flake-utils-HEAD.tar.gz";
    flake-utils.inputs.systems.follows = "nix-systems";
    rust-overlay.url = "tarball+https://git.shell.bsocat.net/rust-overlay/snapshot/rust-overlay-HEAD.tar.gz";
    rust-overlay.inputs.flake-utils.follows = "flake-utils";
    rust-overlay.inputs.nixpkgs.follows = "nixpkgs";
    benaryorg-website.url = "tarball+https://git.shell.bsocat.net/benary.org/snapshot/benary.org-HEAD.tar.gz";
    benaryorg-website.inputs.flake-utils.follows = "flake-utils";
    benaryorg-website.inputs.nixpkgs.follows = "nixpkgs";
    crane.url = "tarball+https://git.shell.bsocat.net/crane/snapshot/crane-HEAD.tar.gz";
    crane.inputs.nixpkgs.follows = "nixpkgs";
    nix-systems.url = "tarball+https://git.shell.bsocat.net/nix-systems/snapshot/nix-systems-HEAD.tar.gz";
    home-manager.url = "tarball+https://git.shell.bsocat.net/home-manager/snapshot/home-manager-HEAD.tar.gz";
    home-manager.inputs.nixpkgs.follows = "nixpkgs";
    darwin.url = "tarball+https://git.shell.bsocat.net/nix-darwin/snapshot/nix-darwin-HEAD.tar.gz";
    darwin.inputs.nixpkgs.follows = "nixpkgs";
    lxddns.url = "tarball+https://git.shell.bsocat.net/lxddns/snapshot/lxddns-HEAD.tar.gz";
